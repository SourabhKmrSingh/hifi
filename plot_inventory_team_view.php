...
$_SESSION['active_menu'] = "plot_inventory_team_followup";
...
<form name="form_actions" method="POST" action="plot_inventory_team_actions.php" ENCTYPE="MULTIPART/FORM-DATA">
<div class="row">
	<div class="col-sm-12 mb-0">
		<div class="form-inline">
			...
			<a href="plot_inventory_team_view.php" class="btn  mb_inline btn-sm btn_delete ml-sm-2 ml-md-0 mb-2">Clear</a>
		</div>
	</div>
</div>
...
<table class="table table-striped table-view" cellspacing="0" width="100%">
	<thead>
	<tr>
		<th class="<?php echo $th_sort1." ".$th_order_cls1; ?>"><a href="plot_inventory_team_view.php?orderby=membership_id&order=<?php echo $th_order1; echo $url_parameters; ?>"><span>User</span> <span class="sorting-indicator"></span></a></th>
		<th width="120">Name</th>
		<th>Sponsor ID</th>
		<th>Name</th>
		<th>Project</th>
		<th>Plot</th>
		<th class="<?php echo $th_sort2." ".$th_order_cls2; ?>"><a href="plot_inventory_team_view.php?orderby=total_amount&order=<?php echo $th_order2; echo $url_parameters; ?>"><span>Total Amount</span> <span class="sorting-indicator"></span></a></th>
		<th>Paid</th>
		<th>Balance</th>
		<th>Percentage</th>
		<th>Status</th>
		<th class="<?php echo $th_sort3." ".$th_order_cls3; ?>"><a href="plot_inventory_team_view.php?orderby=createdate&order=<?php echo $th_order3.''.$url_parameters; ?>"><span>Date</span> <span class="sorting-indicator"></span></a></th>
	</tr>
	</thead>
	<tbody>
	<?php
	if($data['num_rows'] >= 1)
	{
		...
		?>
			<tr class="text-center has-row-actions">
				...
				<td data-label="Project - "><a href="plot_inventory_team_view.php?projectid=<?php echo $validation->db_field_validate($projectRow['projectid']); ?>"><?php echo $validation->db_field_validate($projectRow['title']); ?></a></td>
				<td data-label="Plot - "><a href="plot_inventory_team_view.php?plotid=<?php echo $validation->db_field_validate($plotRow['plotid']); ?>"><?php echo $validation->db_field_validate($plotRow['title']); ?></a></td>
