...
<?php if($_SESSION['register_msg']){?>
  ...
  <div class="form">
	...
	<div class="logo" align="center"><?php if($configRow['logo'] != "") { ?><img src="<?php echo FILE_LOC."".$validation->db_field_validate($configRow['logo']); ?>" style='min-height: 100px;' class="img-responsive mw-100 mb-3" /><?php } ?></div>
