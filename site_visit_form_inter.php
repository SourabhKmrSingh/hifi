...
$fields = array('regid'=>$regid, 'first_name'=>$first_name, 'last_name'=>$last_name, 'email'=>$email, 'mobile'=>$mobile, 'site_visit_time'=> $site_visit_time, 'site_visit_date'=> $site_visit_date, 'total_person' => $total_person, 'pickup_location'=> $pickup_location, 'remarks'=> $remarks, 'user_ip'=>$user_ip);
