...
<table class="table table-striped table-view" cellspacing="0" width="100%">
	...
	<tr>
		...
		<th>E-Wallet</th>
		<!-- <th>Status</th> -->
		<th class="<?php echo $th_sort3." ".$th_order_cls3; ?>"><a href="register_view.php?orderby=createdate&order=<?php echo $th_order3.''.$url_parameters; ?>"><span>Date of Joining</span> <span class="sorting-indicator"></span></a></th>
	</tr>
	</thead>
	<tbody>
	<?php
