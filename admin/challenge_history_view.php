...
<div CLASS="row">
	<div CLASS="col-lg-12">
		<h1 CLASS="page-header">Challenges History <!--<?php if($_SESSION['per_write'] == "1") { ?><a href="challenge_history_form.php?mode=insert" class="btn mb_inline btn-sm btn_submit ml-3">Add New</a><?php } ?>--></h1>
	</div>
</div>
...
<div class="row">
	<div class="col-sm-12 mb-0">
		<div class="form-inline">
			...
			<a href="challenge_history_view.php" class="btn  mb_inline btn-sm btn_delete ml-sm-2 ml-md-0 mb-2">Clear</a>
		</div>
	</div>
</div>
	...
	if($data['num_rows'] >= 1)
	{
		...
		<tr class="text-center has-row-actions">
			...
			<td data-label="Membership ID - ">
				<a href="challenge_history_view.php?regid=<?php echo $validation->db_field_validate($challengehistoryRow['regid']); ?>" class="fw-500"><?php echo $validation->db_field_validate($challengehistoryRow['membership_id']); ?></a>
				
				<div class="row row-actions">
					<div class="col-sm-12">
						<?php if($_SESSION['per_delete'] == "1") { ?>
							<a href="challenge_history_actions.php?q=del&historyid=<?php echo $validation->db_field_validate($challengehistoryRow['historyid']); ?>" onClick="return del();" class="delete">Delete</a>
						<?php } ?>
					</div>
				</div>
			</td>
			<td data-label="Direct Sale - "><?php echo $validation->db_field_validate($challengehistoryRow['direct_sale']); ?></td>
			<td data-label="Group Sale - "><?php echo $validation->db_field_validate($challengehistoryRow['group_sale']); ?></td>
