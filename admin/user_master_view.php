...
<div CLASS="row">
	<div CLASS="col-lg-12">
		<h1 CLASS="page-header">Users <?php if($_SESSION['per_write'] == "1") { ?><a href="user_master_form.php?mode=insert" class="btn mb_inline btn-sm btn_submit ml-3">Add New</a><?php } ?></h1>
	</div>
</div>
