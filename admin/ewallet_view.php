...
$table = "mlm_ewallet";
$id = "ewalletid";
$url_parameters = "&userid=$userid&regid=$regid&membership_id=$membership_id&refno=$refno&type=$type&reason=$reason&status=$status&datefrom=$datefrom&dateto=$dateto";
...
<div CLASS="row">
	<div CLASS="col-lg-12">
		<h1 CLASS="page-header">Members E-Wallet <!--<?php if($_SESSION['per_write'] == "1") { ?><a href="ewallet_form.php?mode=insert" class="btn  btn-sm button">Add New</a><?php } ?>--></h1>
	</div>
</div>
...
<div class="row">
	<div class="col-sm-12 mb-0">
		<div class="form-inline">
			...
			<a href="ewallet_view.php" class="btn  mb_inline btn-sm btn_delete ml-sm-2 ml-md-0 mb-2">Clear</a>
		</div>
	</div>
</div>
...
<table class="table table-striped table-view" cellspacing="0" width="100%">
	...
	if($data['num_rows'] >= 1)
	{
		...
		<tr class="text-center has-row-actions">
			...
			<td data-label="Total Amount - ">&#8377;<?php echo $validation->price_format($ewalletRow['total_amount'] == "" || $ewalletRow['total_amount'] == "0.00" ? $ewalletRow['amount'] : $ewalletRow['total_amount']); ?></td>
			<td data-label="TDS Amount- "><?php echo $validation->db_field_validate(ucwords($ewalletRow['tds_amount'])); ?></td>
