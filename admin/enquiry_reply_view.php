...
<div CLASS="row">
	<div CLASS="col-lg-12">
		<h1 CLASS="page-header">Enquiry History <?php if($_SESSION['per_update'] == "1") { ?><a href="enquiry_form.php?mode=edit&enquiryid=<?php echo $validation->db_field_validate($enquiryRow['enquiryid']); ?>" class="btn mb_inline btn-sm btn_submit ml-3">Update Status</a><?php } ?> <?php if($_SESSION['per_write'] == "1") { ?><a href="enquiry_reply_form.php?mode=insert&enquiryid=<?php echo $enquiryid; ?>" class="btn mb_inline btn-sm btn_submit ml-3">Reply</a><?php } ?></h1>
	</div>
</div>
...
<div class="row">
	<div class="col-sm-12 mb-0">
		<div class="form-inline">
			...
			<a href="enquiry_reply_view.php?enquiryid=<?php echo $enquiryid; ?>" class="btn  mb_inline btn-sm btn_delete ml-sm-2 ml-md-0 mb-2">Clear</a>
		</div>
	</div>
</div>
