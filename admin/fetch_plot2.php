...
{
	$plotResult = $db->view('plotid,title', 'mlm_plots', 'plotid', "and blockid='$blockid' and status='active' and plotid NOT IN (select plotid from mlm_plots_inventory where status = 'active')", 'title asc');
