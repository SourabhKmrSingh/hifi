	...
	$.ajax({
		...
		success: function (response)
		{
			if(response == "Done")
			{
				...
				$(".otp_success").show();
				$("#otp").html("Resend");
				$("#mobile").attr("style","max-width: 266px; border:1px solid green; color:green;");
			...
			else
			{
				$(".otp_success").hide();
				$(".otp_failure").show();
				$("#mobile").attr("style","max-width: 266px; border:1px solid red; color:red;");
			}
		}
	});
}
	...
	$.ajax({
		...
		success: function (response)
		{
			if(response == "Done")
			{
				...
				$("#verification_code").attr("style","max-width: 266px; border:1px solid green; color:green;");
			}
			else
			{
				$(".otp_verified").hide();
				$(".otp_verification_failed").show();
				$("#verification_code").attr("style","max-width: 266px; border:1px solid red; color:red;");
			}
		}
	});
}
...
<div class="form-rows-custom mt-3">
	<?php if($mode == 'edit') { ?>
		...
		<div class="row mb-3">
			...
			<div class="col-sm-9">
				...
				<input type="hidden" name="sponsor_name" value="<?php if($mode == 'edit') echo $validation->db_field_validate($registerRow['sponsor_name']); ?>" />
			</div>
		</div>
		<!-- <div class="row mb-3">
			<div class="col-sm-3">
	...
	<?php } else { ?>
		<div class="row mb-3">
			...
			<div class="col-sm-9">
				<input type="text" name="sponsor_id" id="sponsor_id" class="form-control" value="<?php if($mode == 'edit') echo $validation->db_field_validate($registerRow['sponsor_id']); ?>" onBlur="get_sponsor();" required />
		...
		<div class="row mb-3">
			<div class="col-sm-3">
				<label for="sponsor_id">Sponsor's Name *</label>
			</div>
			<div class="col-sm-9">
				<input type="text" name="sponsor_name" id="sponsor_name" class="form-control" value="<?php if($mode == 'edit') echo $validation->db_field_validate($registerRow['sponsor_name']); ?>" required />
			</div>
		</div>
		<!-- <div class="row mb-3">
			<div class="col-sm-3">
			...
			<div class="col-sm-9">
				<select NAME="planid" CLASS="form-control" ID="planid" required >
					...
					{
					?>
						<option VALUE="<?php echo $validation->db_field_validate($planRow['planid']); ?>" <?php if($mode == 'edit') { if($planRow['planid'] == $registerRow['planid']) echo "selected"; } else { if($planRow['planid'] == '1') echo "selected"; } ?>><?php echo $validation->db_field_validate($planRow['title']); ?></option>
					<?php
					}
					?>
				</select>
...
<!-- 	
	<div class="row mb-3">
		<div class="col-sm-3">
			<label for="rewardid">Reward Stage </label>
		</div>
		<div class="col-sm-9">
			<?php
			...
			<select name="rewardid" id="rewardid" class="form-control" required >
				<option value="" <?php if($mode == 'edit') { if($validation->db_field_validate($registerRow['rewardid']) == "") echo "selected"; } ?>>--select--</option>
				<?php
				...
				{
				?>
					<option VALUE="<?php echo $validation->db_field_validate($rewardRow['rewardid']); ?>" <?php if($mode == 'edit') { if($rewardRow['rewardid'] == $registerRow['rewardid']) echo "selected"; } else { if($rewardRow['rewardid'] == '1') echo "selected"; } ?>><?php echo $validation->db_field_validate($rewardRow['title']); ?></option>
				<?php
				}
				?>
			</select>
	...
	<div class="row mb-3">
		...
		<div class="col-sm-9">
			<input type="text" name="relation_name" id="relation_name" class="form-control" value="<?php echo $validation->db_field_validate($registerRow['relation_name']); ?>" />
		</div>
	</div>
	...
	<div class="row mb-3">
		...
		<div class="col-sm-9">
			<input type="date" name="date_of_birth" id="date_of_birth" class="form-control" value="<?php echo $validation->db_field_validate($registerRow['date_of_birth']); ?>" required />
		</div>
	</div>
		...
		<div class="col-sm-9">
			<div class="form-group text-left">
				<div class="input-group mb-1">
					...
					<input class="form-control" name="mobile" id="mobile" type="text" placeholder="Enter 10 Digit Mobile No." aria-describedby="basic-addon1"  minlength="10" maxlength="10" style="max-width: 22rem;" value="<?php if($mode == 'edit') echo $validation->db_field_validate($registerRow['mobile']); ?>" <?php if($registerRow['mobile'] != "") { ?> readonly <?php } ?> required />

					<!-- <input class="form-control" name="mobile" id="mobile" type="text" placeholder="Enter 10 Digit Mobile No." aria-describedby="basic-addon1" onkeypress="return isNumberKey(event)" minlength="10" maxlength="10" style="max-width: 266px;" value="<?php if($mode == 'edit') echo $validation->db_field_validate($registerRow['mobile']); ?>" <?php if($registerRow['mobile'] != "") { ?> readonly <?php } ?> required /> -->
	...
	<div class="row mb-3">
		...
		<div class="col-sm-9">
			<input type="number" name="pincode" id="pincode" class="form-control" value="<?php echo $validation->db_field_validate($registerRow['pincode']); ?>" />
		</div>
	</div>
	...
	<div class="row mb-3">
		...
		<div class="col-sm-9">
			<input type="text" name="nominee_name" id="nominee_name" class="form-control" value="<?php echo $validation->db_field_validate($registerRow['nominee_name']); ?>" />
		</div>
	</div>
	...
	<div class="row mb-3">
		...
		<div class="col-sm-9">
			<input type="text" name="nominee_relation" id="nominee_relation" class="form-control" value="<?php echo $validation->db_field_validate($registerRow['nominee_relation']); ?>" />
		</div>
	</div>
	...
	<div class="row mb-3">
		...
		<div class="col-sm-9">
			<input type="number" name="nominee_age" id="nominee_age" class="form-control" value="<?php echo $validation->db_field_validate($registerRow['nominee_age']); ?>" />
		</div>
	</div>
	...
	<div class="row mb-3">
		...
		<div class="col-sm-9">
			<input type="text" name="pan_card" id="pan_card" class="form-control" value="<?php echo $validation->db_field_validate($registerRow['pan_card']); ?>" />
		</div>
	</div>
	...
	<div class="row mb-3">
		...
		<div class="col-sm-9">
			<input type="text" name="aadhar_card" id="aadhar_card" class="form-control" value="<?php echo $validation->db_field_validate($registerRow['aadhar_card']); ?>" />
		</div>
	</div>
	...
	<div class="row mt-4 mb-4">
		<div class="col-sm-12">
			...
			{
			?>
				<button type="submit" id='btnSubmit' class="btn  btn-sm mr-2 btn_submit" ><i class="fa fa-arrow-circle-right"></i>&nbsp;&nbsp;Add</button>
			...
			?>
				...
				<?php if($_SESSION['per_delete'] == "1") { ?>
					<a HREF="register_actions.php?q=del&regid=<?php echo $registerRow['regid']; ?>" class="btn  btn-sm btn_delete" onClick="return del();"><i class="fas fa-trash"></i>&nbsp;&nbsp;Delete</a>
				<?php } ?>
			<?php
			}
			?>
