...
$rewardids = implode(",", $_POST['rewardids']);
...
$start_date = $validation->input_validate($_POST['start_date']);
$end_date = $validation->input_validate($_POST['end_date']);
...
$fields = array('planid'=>$planid, 'rewardids'=>$rewardids, 'title'=>$title, 'title_id'=>$title_id, 'direct_sale'=>$direct_sale, 'group_sale'=>$group_sale, 'total_sale'=>$total_sale, 'start_date'=>$start_date, 'end_date'=>$end_date, 'reward'=>$reward, 'order_custom'=>$order_custom, 'description'=>$description, 'imgName'=>$imgName, 'fileName'=>$fileName, 'priority'=>$priority, 'status'=>$status, 'user_ip'=>$user_ip);
