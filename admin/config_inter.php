...
$closing_date = $validation->input_validate($_POST['closing_date']);
$icard_address = $validation->input_validate($_POST['icard_address']);
$icard_email = $validation->input_validate($_POST['icard_email']);
$icard_mobile = $validation->input_validate($_POST['icard_mobile']);
$icard_company_name = $validation->input_validate($_POST['icard_company_name']);
