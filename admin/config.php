...
<div class="form-rows-custom mt-3">
	<h5 class="mb-4 bg-info p-3 text-light">General</h5>
	...
	<!-- <h5 class="mb-4 mt-5 bg-info p-3 text-light">Referral Settings</h5>
	...
	<div class="row mb-3">
	 ...
	 -->
	<h5 class="mb-4 mt-5 bg-info p-3 text-light">MLM Settings</h5>
	...
	<div class="row mb-3">
		<div class="col-sm-3">
			<label for="closing_date">Closing Day Date</label>
		</div>
		<div class="col-sm-9">
			<input type="number" name="closing_date" id="closing_date" min='1' max='31' class="form-control" value="<?php if($mode == 'edit') echo $validation->db_field_validate($configRow['closing_date']); ?>" />
		</div>
	</div>
	<!-- <div class="row mb-3">
		<div class="col-sm-3">
	...
	<!-- <h5 class="mb-4 mt-5 bg-info p-3 text-light">ICARD Details</h5>
	<div class="row mb-3">
		<div class="col-sm-3">
			<label for="icard_company_name">Company Name</label>
		</div>
		<div class="col-sm-9">
			<input type="text" name="icard_company_name" id="icard_company_name" class="form-control" value="<?php if($mode == 'edit') echo $validation->db_field_validate($configRow['icard_company_name']); ?>" />
		</div>
	</div>

	<div class="row mb-3">
		<div class="col-sm-3">
			<label for="icard_address">Address</label>
		</div>
		<div class="col-sm-9">
			<input type="text" name="icard_address" id="icard_address" class="form-control" value="<?php if($mode == 'edit') echo $validation->db_field_validate($configRow['icard_address']); ?>" />
		</div>
	</div>
	
	<div class="row mb-3">
		<div class="col-sm-3">
			<label for="icard_email">Email ID</label>
		</div>
		<div class="col-sm-9">
			<input type="text" name="icard_email" id="icard_email" class="form-control" value="<?php if($mode == 'edit') echo $validation->db_field_validate($configRow['icard_email']); ?>" />
		</div>
	</div>
	
	<div class="row mb-3">
		<div class="col-sm-3">
			<label for="icard_mobile">Mobile No.</label>
		</div>
		<div class="col-sm-9">
			<input type="text" name="icard_mobile" maxlength="10" minlength="10" onkeypress="return isNumberKey(event);" id="icard_mobile" class="form-control" value="<?php if($mode == 'edit') echo $validation->db_field_validate($configRow['icard_mobile']); ?>" />
		</div>
	</div> -->
	
	
	<h5 class="mb-4 mt-5 bg-info p-3 text-light">Email Settings</h5>
	...
	<h5 class="mb-4 mt-5 bg-info p-3 text-light">Media Settings</h5>
	...
	<h6 class="mb-4 mt-4 bg-info p-3 text-light">File sizes</h6>
