...
<div CLASS="row">
	<div CLASS="col-lg-12">
		<h1 CLASS="page-header">Rewards <?php if($_SESSION['per_write'] == "1") { ?><a href="reward_form.php?mode=insert" class="btn mb_inline btn-sm btn_submit ml-3">Add New</a><?php } ?></h1>
	</div>
</div>
...
<div class="row">
	<div class="col-sm-12 mb-0">
		<div class="form-inline">
			...
			<a href="reward_view.php" class="btn  mb_inline btn-sm btn_delete ml-sm-2 ml-md-0 mb-2">Clear</a>
		</div>
	</div>
</div>
...
<table class="table table-striped table-view" cellspacing="0" width="100%">
	...
	<tr>
		...
		<th class="<?php echo $th_sort1." ".$th_order_cls1; ?>"><a href="reward_view.php?orderby=title&order=<?php echo $th_order1; echo $url_parameters; ?>"><span>Title</span> <span class="sorting-indicator"></span></a></th>
		<th>Author</th>
		<th>Direct Sale</th>
		<th>Group Sale</th>
		<th>Incentive</th>
	...
	if($data['num_rows'] >= 1)
	{
		...
		<tr class="text-center has-row-actions">
			...
			<td data-label="Direct Sale - "><?php echo $validation->db_field_validate($rewardRow['direct_sale']); ?></td>
			<td data-label="Group Sale - "><?php echo $validation->db_field_validate($rewardRow['group_sale']); ?></td>
			<td data-label="Incentive - ">&#8377;<?php echo $validation->price_format($rewardRow['incentive']); ?></td>
			<td data-label="Salary - ">&#8377;<?php echo $validation->price_format($rewardRow['salary']); ?></td>
			...
			<td data-label="Status - "><font color="<?php if($rewardRow['status'] == "active") { echo "green"; } else { echo "red"; } ?>"><?php echo $validation->db_field_validate(ucfirst($rewardRow['status'])); ?></font></td>
