...
<div CLASS="row">
	<div CLASS="col-lg-12">
		<h1 CLASS="page-header">Enquiry History <a href="enquiry_reply_form.php?mode=insert&enquiryid=<?php echo $enquiryid; ?>" class="btn mb_inline btn-sm btn_submit ml-3">Reply</a></h1>
	</div>
</div>
